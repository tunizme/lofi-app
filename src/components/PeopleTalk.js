...
const PeopleTalk = () => {
  const [peopleTalk, setPeopleTalk] = useState(false);
  ...
  return (
    <HeadlessTippy
      ...
      render={() => (
        <PopperWrapper>
          <p onClick={() => setPeopleTalk((pre) => !pre)} className="mb-0">
            People Talk
          </p>
          {peopleTalk && (
            <div className="px-2">
    ...
    >
      ...
      >
        ...
        {peopleTalk && (
          <ReactAudioPlayer
            ref={audio}
            src={"../assets/songs/people_talk_inside.mp3"}
            autoPlay
            loop
            volume={value / 100}
